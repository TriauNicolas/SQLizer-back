...
import { z } from 'zod';
import { createWorkgroup, deleteWorkgroup, getFirstWorkgroupById, getWorkGroupByGroupId } from '../services/workgroups.services';
import { createUserWorkgroup, deleteManyUsersWorkgroups, getUserWorkgroupByUserId, getUserWorkgroupByUserIdAndWorkgroupId, updateUsersWorkgroups } from '../services/usersWorkgroups.services';
import { getUserByEmail, getUserById } from '../services/authentication.services';
...
export const deleteWorkgroupController = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const relation = await getUserWorkgroupByUserIdAndWorkgroupId(user.id, query.group_id);
